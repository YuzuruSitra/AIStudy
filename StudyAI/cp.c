...
void conv(double filter[][FILTERSIZE], double e[][INPUTSIZE], double convout[][INPUTSIZE])
{
	...
	int startpoint = FILTERSIZE / 2;	/* 畳み込みの範囲の下限 */
