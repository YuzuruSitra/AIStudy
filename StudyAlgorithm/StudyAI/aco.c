...
//
//void walk(int cost[2][STEP], double pheromone[2][STEP], int mstep[NOA][STEP]); /* 蟻を歩かせる */
//void update(int cost[2][STEP], double pheromone[2][STEP], int mstep[NOA][STEP]); /* フェロモンの更新 */
//double rand1();
//int rand01();
//
///******************/
